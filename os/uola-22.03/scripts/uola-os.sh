...
sed -i  '/bash/a\\        iperf3 \\' include/target.mk
sed -i  '/iperf3/a\\        acl \\' include/target.mk
sed -i  '/acl/a\\        zsh \\' include/target.mk
sed -i  '/zsh/a\\        curl \\' include/target.mk
sed -i  '/curl/a\\        wget \\' include/target.mk
sed -i  '/wget/a\\        htop \\' include/target.mk
sed -i  '/htop/a\\        screen \\' include/target.mk
sed -i  '/screen/a\\        vim-fuller \\' include/target.mk
sed -i  '/vim-fuller/a\\        tcping \\' include/target.mk
sed -i  '/tcping/a\\        ipv6helper \\' include/target.mk
sed -i  '/ipv6helper/a\\        sysstat \\' include/target.mk
sed -i  '/sysstat/a\\        6in4 \\' include/target.mk
sed -i  '/6in4/a\\        unzip \\' include/target.mk
sed -i  '/unzip/a\\        gzip \\' include/target.mk
sed -i  '/gzip/a\\        tar \\' include/target.mk
sed -i  '/gzip/a\\        sed \\' include/target.mk
sed -i  '/sed/a\\        lrzsz \\' include/target.mk
sed -i  '/lrzsz/a\\        lscpu \\' include/target.mk
sed -i  '/lscpu/a\\        lsof \\' include/target.mk
sed -i  '/lsof/a\\        fdisk \\' include/target.mk
sed -i  '/fdisk/a\\        blkid \\' include/target.mk
sed -i  '/blkid/a\\        usbutils \\' include/target.mk
sed -i  '/usbutils/a\\        coreutils-nohup \\' include/target.mk
sed -i  '/coreutils-nohup/a\\        bind-dig \\' include/target.mk
sed -i  '/bind-dig/a\\        jq \\' include/target.mk
sed -i  '/jq/a\\        bc \\' include/target.mk
sed -i  '/bc/a\\        openssl-util \\' include/target.mk
...
sed -i  '/libustream-openssl/a\\        tinc \\' include/target.mk
